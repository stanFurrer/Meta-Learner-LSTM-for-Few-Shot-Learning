...
# Hyper-parameters
FLAGS.add_argument('--n-shot', type=int, default=1,
...
FLAGS.add_argument('--meta-learner', choices=['lstm', 'full-lstm', 'gru', 'corr-lstm', 'lstm-wo-init'], default="lstm")
FLAGS.add_argument('--meta-dropout', type=float, default=0,
                   help="Dropout applied to meta-learner cI (learner initializer)")

# Paths
FLAGS.add_argument('--data', default='omniglot',
                   help="Name of dataset")
FLAGS.add_argument('--data-root', type=str, default="data/omniglot",
...
def main():
    ...
    if args.mode == 'test':
        ...
        test_loader = source.prepare_data_omniglot(args)
    ...
    # Get data loaders
    train_loader, val_loader = source.prepare_data_omniglot(args)
