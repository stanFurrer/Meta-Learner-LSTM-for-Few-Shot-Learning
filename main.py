...
FLAGS.add_argument('--meta-learner', choices=['lstm', 'full-lstm', 'gru', 'sgd'], default="lstm")
FLAGS.add_argument('--meta-dropout', type=float, default=0,
                   help="Dropout applied to meta-learner cI (learner initializer)")

# Paths
FLAGS.add_argument('--data', default='miniimagenet',
                   help="Name of dataset")
FLAGS.add_argument('--data-root', type=str, default="data/miniImagenet",
